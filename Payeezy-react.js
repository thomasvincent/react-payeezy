...
export default class ReactPayeezy extends React.Component {
  static defaultProps = {
    className: 'Payeezy',
    label: 'Pay With Card',
    locale: 'auto',
  ...
  static propTypes = {
    ...
    PayeezyApiKey: React.PropTypes.string.isRequired,

    // HMAC of payload signed using api secret
    PayeezyAuthorization: React.PropTypes.string.isRequired,

    // Epoch time stamp aka. unix time
    PayeezynNonce: React.PropTypes.string.isRequired,
    ...
    locale: React.PropTypes.oneOf([
      'auto', // (Default) Automatically chosen by
      'zh', // Chinese
      'nl', // Dutch
      'en', // English
      'fr', // French
  ...
  render() {
    ...
    return this.props.disabled
      ...
      : this.renderDefaultPayeezyButton();
  }
}
